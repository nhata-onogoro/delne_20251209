...
const useCases = [
  {
    ...
    supportClass: "bg-[#F5B041]/10 border-[#F5B041]",
    imageWrapClass: "md:order-1",
    imageAccentClass:
      "-top-4 -left-4 bg-[#F5B041]/15 group-hover:-translate-x-2 group-hover:-translate-y-2",
  ...
  },
  {
    ...
    imageAccentClass:
      "-top-4 -right-4 bg-[#F5B041]/15 group-hover:translate-x-2 group-hover:-translate-y-2",
